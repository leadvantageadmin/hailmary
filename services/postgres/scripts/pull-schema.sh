...
# PostgreSQL Schema Pull Script
# Pulls schema from Schema API service for PostgreSQL service

echo "📥 Pulling schema for PostgreSQL service..."
...
echo "   • Check schema: ./scripts/validate-schema.sh"
